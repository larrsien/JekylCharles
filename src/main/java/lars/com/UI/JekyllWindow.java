...
public class JekyllWindow extends CharacterWindow {
    ...
    private static final List<String> LEFT_CLICK_PHRASES = List.of(
            "Нервный тик или избыток свободного времени?",
            "Что ты пытаешься здесь нащупать?",
            "Ты мешаешь мне.",
            "Если хочешь чужого внимания, нужно находить достойные способы его привлечения. ",
            "У тебя нет дел поважнее?",
            "Ты нажал. Что теперь? Ты просто кликаешь в никуда, а я просто за этим наблюдаю."
    );
    private static final List<String> RIGHT_CLICK_PHRASES = List.of(
            "Здесь ничего нет.",
            "Ищешь меню? Оно не здесь.",
            "Ты тыкаешь в пустоту.",
            "За иллюзией выбора – это к Шарлю.",
            "Промах."
    );
